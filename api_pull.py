...
def create_parks_db():
    connection = sqlite3.connect("parks.db", charset="utf8")
...
def create_activities_db():
    connection = sqlite3.connect("activities.db", charset="utf8")
    cursor = connection.cursor()
...
def create_amenities_db():
    connection = sqlite3.connect("amenities.db", charset="utf8")
    cursor = connection.cursor()
